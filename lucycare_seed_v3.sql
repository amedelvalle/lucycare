-- ============================================================
-- LUCYCARE — Seed Data (Versión 3 — Fix auth.users)
-- Abril 2026
-- ============================================================
-- EJECUTAR DESPUÉS del schema y las políticas RLS.
-- 
-- FIX: Crea usuarios de prueba en auth.users primero,
-- lo cual dispara automáticamente el trigger que crea el profile.
-- Luego actualiza los profiles y crea clinics/doctors/services.
-- ============================================================
...
INSERT INTO municipalities (id, name, department_id, district) VALUES
  ...
  ('CH-13', 'Tejutla', 'CH', 'Chalatenango Centro'),
  ('CH-14', 'Arcatao', 'CH', 'Chalatenango Sur'),
  ('CH-15', 'Azacualpa', 'CH', 'Chalatenango Sur'),
  ('CH-16', 'Cancasque', 'CH', 'Chalatenango Sur'),
  ('CH-17', 'Chalatenango', 'CH', 'Chalatenango Sur'),
  ('CH-18', 'Comalapa', 'CH', 'Chalatenango Sur'),
  ('CH-19', 'Concepción Quezaltepeque', 'CH', 'Chalatenango Sur'),
  ('CH-20', 'El Carrizal', 'CH', 'Chalatenango Sur'),
  ('CH-21', 'La Laguna', 'CH', 'Chalatenango Sur'),
  ('CH-22', 'Las Vueltas', 'CH', 'Chalatenango Sur'),
  ('CH-23', 'Nombre de Jesús', 'CH', 'Chalatenango Sur'),
  ('CH-24', 'Nueva Trinidad', 'CH', 'Chalatenango Sur'),
  ('CH-25', 'Ojos de Agua', 'CH', 'Chalatenango Sur'),
  ('CH-26', 'Potonico', 'CH', 'Chalatenango Sur'),
  ('CH-27', 'San Antonio de la Cruz', 'CH', 'Chalatenango Sur'),
  ('CH-28', 'San Antonio Los Ranchos', 'CH', 'Chalatenango Sur'),
  ('CH-29', 'San Francisco Lempa', 'CH', 'Chalatenango Sur'),
  ('CH-30', 'San Isidro Labrador', 'CH', 'Chalatenango Sur'),
  ('CH-31', 'San José Cancasque', 'CH', 'Chalatenango Sur'),
  ('CH-32', 'San José Las Flores', 'CH', 'Chalatenango Sur'),
  ('CH-33', 'San Luis del Carmen', 'CH', 'Chalatenango Sur');
...
-- 7. MÉDICOS DE PRUEBA
-- ============================================================
-- Insertamos usuarios de prueba en auth.users usando la función
-- interna de Supabase. Esto dispara automáticamente el trigger
-- handle_new_user() que crea el profile.
-- ============================================================

-- Crear 12 usuarios de prueba en auth.users
-- Usamos emails ficticios con contraseña de prueba
INSERT INTO auth.users (
  ...
  ('a0000001-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'carlos.mendoza@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dr. Carlos Mendoza García","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'maria.lopez@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dra. María Fernanda López","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'roberto.sanchez@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dr. Roberto Sánchez Ruiz","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'ana.morales@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dra. Ana Patricia Morales","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'luis.ramirez@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dr. Luis Alberto Ramírez","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'carmen.torres@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dra. Carmen Beatriz Torres","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'jorge.castillo@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dr. Jorge Eduardo Castillo","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000008', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'sofia.herrera@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dra. Sofía Gabriela Herrera","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000009', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'miguel.flores@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dr. Miguel Ángel Flores","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'daniela.vega@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dra. Daniela Alejandra Vega","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'fernando.ortiz@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dr. Fernando Javier Ortiz","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, ''),
  ('a0000001-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   'valentina.cruz@lucycare.test', crypt('TestLucy2026!', gen_salt('bf')),
   now(), now(), now(),
   '{"full_name":"Dra. Valentina Isabel Cruz","role":"doctor"}'::jsonb,
   '{"provider":"email","providers":["email"]}'::jsonb,
   false, '');

-- El trigger handle_new_user() ya creó los profiles automáticamente.
-- Ahora actualizamos los profiles con teléfono.
UPDATE profiles SET phone = '+503 2234 5678' WHERE id = 'a0000001-0000-0000-0000-000000000001';
UPDATE profiles SET phone = '+503 2345 6789' WHERE id = 'a0000001-0000-0000-0000-000000000002';
UPDATE profiles SET phone = '+503 2456 7890' WHERE id = 'a0000001-0000-0000-0000-000000000003';
UPDATE profiles SET phone = '+503 2567 8901' WHERE id = 'a0000001-0000-0000-0000-000000000004';
UPDATE profiles SET phone = '+503 2678 9012' WHERE id = 'a0000001-0000-0000-0000-000000000005';
UPDATE profiles SET phone = '+503 2789 0123' WHERE id = 'a0000001-0000-0000-0000-000000000006';
UPDATE profiles SET phone = '+503 2890 1234' WHERE id = 'a0000001-0000-0000-0000-000000000007';
UPDATE profiles SET phone = '+503 2901 2345' WHERE id = 'a0000001-0000-0000-0000-000000000008';
UPDATE profiles SET phone = '+503 2012 3456' WHERE id = 'a0000001-0000-0000-0000-000000000009';
UPDATE profiles SET phone = '+503 2123 4567' WHERE id = 'a0000001-0000-0000-0000-000000000010';
UPDATE profiles SET phone = '+503 2234 5679' WHERE id = 'a0000001-0000-0000-0000-000000000011';
UPDATE profiles SET phone = '+503 2345 6780' WHERE id = 'a0000001-0000-0000-0000-000000000012';
...
INSERT INTO doctors (id, profile_id, clinic_id, specialty_id, license_number, experience_years, bio, consultation_fee, languages, education, is_verified, is_published, lucy_status, booking_enabled) VALUES
  ('d0000001-0000-0000-0000-000000000001', 'a0000001-0000-0000-0000-000000000001', 'c0000001-0000-0000-0000-000000000001', (SELECT id FROM specialties WHERE name='Cardiología' LIMIT 1), 'JVPM-1234', 15, 'Especialista en cardiología con más de 15 años de experiencia.', 80.00, '{Español,Inglés}', '[{"institucion":"Universidad de El Salvador","titulo":"Medicina"},{"institucion":"Cleveland Clinic","titulo":"Fellowship Cardiología"}]'::jsonb, false, true, 'booking_enabled', true),
  ('d0000001-0000-0000-0000-000000000002', 'a0000001-0000-0000-0000-000000000002', 'c0000001-0000-0000-0000-000000000002', (SELECT id FROM specialties WHERE name='Pediatría' LIMIT 1), 'JVPM-2345', 12, 'Pediatra dedicada al cuidado integral de niños y adolescentes.', 60.00, '{Español}', '[{"institucion":"Universidad de El Salvador","titulo":"Medicina"},{"institucion":"Hospital Bloom","titulo":"Pediatría"}]'::jsonb, false, true, 'listed_only', false),
  ('d0000001-0000-0000-0000-000000000003', 'a0000001-0000-0000-0000-000000000003', 'c0000001-0000-0000-0000-000000000003', (SELECT id FROM specialties WHERE name='Dermatología' LIMIT 1), 'JVPM-3456', 18, 'Dermatólogo certificado con amplia experiencia.', 75.00, '{Español,Inglés}', '[{"institucion":"U. Matías Delgado","titulo":"Medicina"},{"institucion":"Hospital Rosales","titulo":"Dermatología"}]'::jsonb, false, true, 'claimed', false),
  ('d0000001-0000-0000-0000-000000000004', 'a0000001-0000-0000-0000-000000000004', 'c0000001-0000-0000-0000-000000000004', (SELECT id FROM specialties WHERE name='Neurología' LIMIT 1), 'JVPM-4567', 20, 'Neuróloga especializada en cefaleas, epilepsia y trastornos del movimiento.', 85.00, '{Español,Inglés,Francés}', '[{"institucion":"Universidad de El Salvador","titulo":"Medicina"},{"institucion":"Hospital Rosales","titulo":"Neurología"}]'::jsonb, true, true, 'verified', true),
  ('d0000001-0000-0000-0000-000000000005', 'a0000001-0000-0000-0000-000000000005', 'c0000001-0000-0000-0000-000000000005', (SELECT id FROM specialties WHERE name='Oftalmología' LIMIT 1), 'JVPM-5678', 14, 'Oftalmólogo especializado en cirugía refractiva y cataratas.', 70.00, '{Español,Inglés}', '[{"institucion":"U. Evangélica","titulo":"Medicina"},{"institucion":"Hospital Rosales","titulo":"Oftalmología"}]'::jsonb, false, true, 'booking_enabled', true),
  ('d0000001-0000-0000-0000-000000000006', 'a0000001-0000-0000-0000-000000000006', 'c0000001-0000-0000-0000-000000000006', (SELECT id FROM specialties WHERE name='Ginecología' LIMIT 1), 'JVPM-6789', 16, 'Ginecóloga y obstetra dedicada a la salud integral de la mujer.', 65.00, '{Español,Inglés}', '[{"institucion":"Universidad de El Salvador","titulo":"Medicina"},{"institucion":"Hospital de Maternidad","titulo":"Ginecología"}]'::jsonb, false, true, 'listed_only', false),
  ('d0000001-0000-0000-0000-000000000007', 'a0000001-0000-0000-0000-000000000007', 'c0000001-0000-0000-0000-000000000007', (SELECT id FROM specialties WHERE name='Traumatología' LIMIT 1), 'JVPM-7890', 22, 'Traumatólogo con más de dos décadas de experiencia.', 90.00, '{Español,Inglés}', '[{"institucion":"Universidad de El Salvador","titulo":"Medicina"},{"institucion":"HSS New York","titulo":"Cirugía de Columna"}]'::jsonb, false, true, 'claimed', false),
  ('d0000001-0000-0000-0000-000000000008', 'a0000001-0000-0000-0000-000000000008', 'c0000001-0000-0000-0000-000000000008', (SELECT id FROM specialties WHERE name='Psiquiatría' LIMIT 1), 'JVPM-8901', 13, 'Psiquiatra especializada en trastornos del ánimo y ansiedad.', 75.00, '{Español,Inglés}', '[{"institucion":"UCA","titulo":"Medicina"},{"institucion":"Hospital Rosales","titulo":"Psiquiatría"}]'::jsonb, false, true, 'booking_enabled', true),
  ('d0000001-0000-0000-0000-000000000009', 'a0000001-0000-0000-0000-000000000009', 'c0000001-0000-0000-0000-000000000009', (SELECT id FROM specialties WHERE name='Medicina General' LIMIT 1), 'JVPM-9012', 10, 'Médico general dedicado a la atención primaria de salud.', 50.00, '{Español}', '[{"institucion":"Universidad de El Salvador","titulo":"Medicina"}]'::jsonb, false, true, 'listed_only', false),
  ('d0000001-0000-0000-0000-000000000010', 'a0000001-0000-0000-0000-000000000010', 'c0000001-0000-0000-0000-000000000010', (SELECT id FROM specialties WHERE name='Endocrinología' LIMIT 1), 'JVPM-0123', 17, 'Endocrinóloga especializada en diabetes y tiroides.', 80.00, '{Español,Inglés}', '[{"institucion":"U. Matías Delgado","titulo":"Medicina"},{"institucion":"Hospital Rosales","titulo":"Endocrinología"}]'::jsonb, true, true, 'verified', true),
  ('d0000001-0000-0000-0000-000000000011', 'a0000001-0000-0000-0000-000000000011', 'c0000001-0000-0000-0000-000000000011', (SELECT id FROM specialties WHERE name='Cardiología' LIMIT 1), 'JVPM-1235', 25, 'Cardiólogo intervencionista con vasta experiencia.', 95.00, '{Español,Inglés}', '[{"institucion":"Universidad de El Salvador","titulo":"Medicina"},{"institucion":"Mayo Clinic","titulo":"Cardiología Intervencionista"}]'::jsonb, false, true, 'claimed', false),
  ('d0000001-0000-0000-0000-000000000012', 'a0000001-0000-0000-0000-000000000012', 'c0000001-0000-0000-0000-000000000012', (SELECT id FROM specialties WHERE name='Pediatría' LIMIT 1), 'JVPM-2346', 11, 'Pediatra especializada en lactancia materna y desarrollo infantil.', 55.00, '{Español}', '[{"institucion":"U. Evangélica","titulo":"Medicina"},{"institucion":"Hospital Bloom","titulo":"Pediatría"}]'::jsonb, false, true, 'booking_enabled', true);

-- Servicios para médicos con booking
