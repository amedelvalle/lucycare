...
- `docs/HANDOFF_LUCYCARE_NUEVA_VENTANA_2026-06-18.md` — **PUNTO DE ENTRADA VIGENTE** (estado final post-#154, F4 cerrado, F4-D diferido, backlog vivo, protocolo de arranque). Leer este PRIMERO. Los handoffs `2026-06-11` y `2026-06-15` quedan como históricos.
