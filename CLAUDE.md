...
- `docs/HANDOFF_LUCYCARE_NUEVA_VENTANA_2026-06-11.md` — **punto de entrada de la ventana actual** (estado final, frentes cerrados, decisiones vigentes, pendientes vivos).
