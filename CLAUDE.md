...
- `docs/ANALISIS_PACIENTE_GLOBAL.md` — modelo de identidad de paciente (Fases 1, 2, 3 y 5 ✅ live; Fase 4: F4-1/F4-2/F4-3 search+UI A+UI B + unmerge backend + unmerge UI "Deshacer fusión" ✅ live #135–#149 (`s7_48`), F4-3b/F4-D pendientes).
