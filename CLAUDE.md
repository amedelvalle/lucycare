...
- `docs/ANALISIS_PACIENTE_GLOBAL_OWNERSHIP.md` — ownership del paciente: "el médico gestiona una relación clínica local; LucyCare gobierna la identidad global" (D1–D7 aprobadas; B2 confirmación post-claim ✅ live en #128/`s7_43`; B1 merge admin pendiente con diseño propio).
