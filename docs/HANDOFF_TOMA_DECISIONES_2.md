...
2. **Confirmar HEAD final:** `ff4ce93` o posterior. **Leer primero `docs/HANDOFF_LUCYCARE_NUEVA_VENTANA_2026-06-15.md`.**
3. **Confirmar PRs mergeados hasta #144.**
4. **Confirmar migraciones hasta `s7_47`** (aplicadas en Supabase). **#118 = `s7_40`**; **#120 = `s7_41`**; **#122 = `s7_42`** (re-aplicada completa tras 2 ajustes); **#128 = `s7_43`**; **#132 = `s7_44`**; **#135 = `s7_45`** (F4-1 claim tolerante); **#138 = `s7_46`** (F4-2 backend merge admin); **#140 = `s7_47`** (F4-3-search RPC candidatos); **#142 = UI PR A read-only (sin migración)**; **#144 = UI PR B merge real (sin migración)**.
