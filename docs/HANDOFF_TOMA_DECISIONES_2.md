...
2. **Confirmar HEAD final:** `ef94d99` o posterior (+ el PR documental de cierre de esta ventana).
3. **Confirmar PRs mergeados hasta #116** (+ el PR documental de cierre de esta ventana).
4. **Confirmar migraciones hasta `s7_43`** (aplicadas en Supabase). **#118 = `s7_40`**; **#120 = `s7_41`**; **#122 = `s7_42`** (re-aplicada completa tras 2 ajustes; DB/repo normalizados); **#128 = `s7_43`** (B2 confirmación post-claim).
