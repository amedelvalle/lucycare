...
2. **Confirmar HEAD final:** `a7b368d` o posterior. **Leer primero `docs/HANDOFF_LUCYCARE_NUEVA_VENTANA_2026-06-15.md`.**
3. **Confirmar PRs mergeados hasta #149.**
4. **Confirmar migraciones hasta `s7_48`** (aplicadas en Supabase). **#118 = `s7_40`**; **#120 = `s7_41`**; **#122 = `s7_42`** (re-aplicada completa tras 2 ajustes); **#128 = `s7_43`**; **#132 = `s7_44`**; **#135 = `s7_45`** (F4-1 claim tolerante); **#138 = `s7_46`** (F4-2 backend merge admin); **#140 = `s7_47`** (F4-3-search RPC candidatos); **#142 = UI PR A read-only (sin migración)**; **#144 = UI PR B merge real (sin migración)**; **#147 = `s7_48`** (Unmerge formal backend; re-aplicado 1 vez por fix de cast `document_type`).
