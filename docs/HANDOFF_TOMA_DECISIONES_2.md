...
2. **Confirmar HEAD final:** `22bef3b` o posterior (+ el PR documental de handoff de esta ventana). **Leer primero `docs/HANDOFF_LUCYCARE_NUEVA_VENTANA_2026-06-11.md`.**
3. **Confirmar PRs mergeados hasta #116** (+ el PR documental de cierre de esta ventana).
4. **Confirmar migraciones hasta `s7_44`** (aplicadas en Supabase). **#118 = `s7_40`**; **#120 = `s7_41`**; **#122 = `s7_42`** (re-aplicada completa tras 2 ajustes); **#128 = `s7_43`**; **#132 = `s7_44`** (re-aplicada con delta final — DB/repo normalizados en `c24a7a2`).
