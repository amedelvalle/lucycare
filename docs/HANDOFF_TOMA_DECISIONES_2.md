...
- **Paciente Global Fase 4** — merge admin de duplicados (`admin_merge_patients`, audit + reversibilidad + dry-run); considerar la nota del `UNIQUE` de F3. (Frente grande/delicado: mueve historial clínico.)
- **Paciente Global Fase 5** — dedup preventivo cross-clinic al crear paciente (walk-in).
