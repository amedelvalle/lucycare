...
Hoy hacemos: ___[siguiente frente a decidir — ninguno arrancado:
  ...
  4. Pendientes acotados (paginación del Home; ~~PanelLayout/useClinicContext~~ ✅ #116; ~~RPC F5 tolerante~~ ✅ #118/s7_40; ~~vista global /admin/lista-espera~~ ✅ #120/s7_41; ~~afiliación paciente existente~~ ✅ #122/s7_42).
]___
```
