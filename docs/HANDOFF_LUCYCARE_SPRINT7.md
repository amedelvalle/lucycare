...
Hoy hacemos: ___[siguiente frente a decidir — ninguno arrancado:
  ...
  2. Paciente Global Fase 4 (merge admin de duplicados — grande/delicado; ojo UNIQUE(clinic,document) de F3; queda DETRÁS del modelo de identidad ya aprobado);
