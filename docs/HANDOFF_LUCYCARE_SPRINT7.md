...
Hoy hacemos: ___[siguiente frente a decidir — ninguno arrancado:
  ...
  4. Pendientes acotados (vista global /admin/lista-espera, paginación del Home; ~~causa raíz PanelLayout/useClinicContext~~ ✅ cerrada en #116);
