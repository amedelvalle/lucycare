...
> ⚠️ **HISTÓRICO — superado.** El punto de entrada VIGENTE es
> `docs/HANDOFF_LUCYCARE_NUEVA_VENTANA_2026-06-18.md` (cierre post-#154, F4-3b live).
> Este documento queda como histórico de la ventana anterior.
